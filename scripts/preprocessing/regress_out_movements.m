function regress_out_movements()
% =========================================================================
...
for iSub = 1:nSubjects
    ...
    for iSess = 1:nSleepDataSession
        ...
        movementTimeSeriesFile = fullfile(MAIN_DIRECTORY,'/data/Movement_files',['rp_SleepDataSubject', num2str(iSub),'Session',sprintf('%02d',iSess),'.txt']);

        ACovariablesDef.ort_file    = movementTimeSeriesFile;
