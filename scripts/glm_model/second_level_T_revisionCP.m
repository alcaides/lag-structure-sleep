function second_level_T_revisionCP()
% =========================================================================
...
dataDirectory       = fullfile(MAIN_DIRECTORY,'results/GLM/first_level_revision');
resultsDirectory    = fullfile(MAIN_DIRECTORY,'results/GLM/second_level_batchs_revision');
batchDirectory      = fullfile(MAIN_DIRECTORY,'scripts/glm_model/second_level_batchs_revision');
...
for iContrast = 1:nContrasts;
    ...
    matlabbatch{1}.spm.stats.factorial_design.multi_cov(1).files        = {fullfile(MAIN_DIRECTORY,'results','GLM','D1.txt')};
