...
resultsDirectory    = fullfile(MAIN_DIRECTORY,'results/GLM/first_level_revision');
batchDirectory      = fullfile(MAIN_DIRECTORY,'scripts/glm_model/first_level_batchs_revision');
nSubjects           =  3;
